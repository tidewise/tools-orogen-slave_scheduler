...
#ifndef SLAVE_SCHEDULER_ORDEREDSCHEDULINGTASK_TASK_HPP
...
process the children in said order, placing the rest at the end of the list.
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','slave_scheduler::OrderedSchedulingTask')
     end
     \endverbatim
    ...
    public:
         ...
         */
        OrderedSchedulingTask(std::string const& name = "slave_scheduler::OrderedSchedulingTask");
         ...
         * 
         */
        OrderedSchedulingTask(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of OrderedSchedulingTask
         */
