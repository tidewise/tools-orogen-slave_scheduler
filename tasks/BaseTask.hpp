...
#ifndef SLAVE_SCHEDULER_BASETASK_TASK_HPP
#define SLAVE_SCHEDULER_BASETASK_TASK_HPP

#include "slave_scheduler/BaseTaskBase.hpp"
...
namespace slave_scheduler{
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','slave_scheduler::BaseTask')
     end
     \endverbatim
    ...
    public:
         ...
         */
        BaseTask(std::string const& name = "slave_scheduler::BaseTask");
